    ...
    <div class="relative w-auto pointer-events-none modal-dialog modal-dialog-centered">
        <div
            ...
            <div
                ...
                >
                <h5 class="text-xl font-medium leading-normal text-gray-800" id="addCategoryModalLabel">
                    Add Category
                </h5>
                <button type="button"
            ...
            <div class="relative p-4 modal-body">
                <form id="add-category-form" action="{{ route('menu.inventories.categories.add') }}" method="post">
                    @csrf
