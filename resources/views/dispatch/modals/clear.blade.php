<div
    ...
    <div class="relative w-auto pointer-events-none modal-dialog modal-dialog-centered">
        ...
        <div class="relative p-4 modal-body">
            <form id="clear-ord-item-form" action="{{ route('dispatch.order.clear') }}" method="post">
                @csrf
                <label class="block mb-4 text-sm">
                    <p>Are you sure that you want to clear order <strong x-text="$store.data.orderId"></strong>? Clearing order will tag order items with status <em>Done</em> as <em>Served</em> (void not included) and remove items from dashboard.</p>
