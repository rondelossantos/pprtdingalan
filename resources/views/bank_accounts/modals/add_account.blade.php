            ...
            <div class="relative p-4 modal-body">
                <form id="add-account-form" action="{{ route('bank.account.store') }}" method="post" autocomplete="off">
                    ...
                    <label class="block mb-4 text-sm">
                        ...
                        <input class="styled-input" name="bank" type="text" placeholder="Enter bank" required>
                    </label>
                    <label class="block mb-4 text-sm">
                        <span class="text-gray-700">Account Name</span>
                        <input class="styled-input" name="account_name" type="text" placeholder="Enter account name" required>
                    </label>
                    <label class="block mb-4 text-sm">
                        <span class="text-gray-700">Account Number</span>
                        <input class="styled-input" name="account_number" type="text" placeholder="Enter account number">
                    </label>
                </form>
            </div>
            <div
